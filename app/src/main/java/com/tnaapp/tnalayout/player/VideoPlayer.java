...
package com.tnaapp.tnalayout.player;
...
/**
 * The VideoPlayer is responsible for displaying both videos and ads. This is accomplished using two
...
//                ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    /**
     * When you are finished using this {@link VideoPlayer}, make sure to call this method.
     */
    public void release() {
        if (adPlayer != null) {
            adPlayer.release();
    ...
    /**
     * Make the ads loader request an ad with the ad tag URL which this {@link VideoPlayer} was
     * created with
     */
